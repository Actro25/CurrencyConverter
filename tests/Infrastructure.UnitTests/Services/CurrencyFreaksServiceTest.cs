...
namespace Infrastructure.UnitTests.Services
{
    ...
    public class CurrencyFreaksServiceTest
    {
        ...
        public async Task GetAllCurreencyInfoAsync_Null_ReturnsNewListCurrencyInfoDto()
        {
            ...
            var service = new CurrencyFreaksService(client);
        ...
        [Fact]
        public async Task GetAllCurreencyInfoAsync_ApiException_ReturnsNewListCurrencyInfoDtoAsync()
        {
            var fakeHandler = new FakeHttpMessageHandler();
            fakeHandler.SetResponse(new HttpResponseMessage
            {
        ...
        [Fact]
        public async Task GetAllCurreencyInfoAsync_JsonException_ReturnsNewListCurrencyInfoDtoAsync()
        {
            var fakeHandler = new FakeHttpMessageHandler();
            fakeHandler.SetResponse(new HttpResponseMessage
            {
        ...
        [Fact]
        public async Task GetAllCurreencyInfoAsync_UnRelatedData_ReturnsNewListCurrencyInfoDtoAsync()
        {
            var fakeHandler = new FakeHttpMessageHandler();
            fakeHandler.SetResponse(new HttpResponseMessage
            {
